...
#define CALIBRATION_PHASE_SPEED_2 220 // Скорость перемещения картеки при второй фазе калибровки (движение картеки от концевика), см/мин
...
typedef struct
{
	...
	uint8_t State; 	// 3 бит - Состояние вывода iCarriageStop 0 - коневик отжат, 1 - коневик нажат кареткой
